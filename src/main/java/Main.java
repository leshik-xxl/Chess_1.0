...
public class Main {
    public static void main(String[] args){
        ...
        Point point = new Point(CordinateX.A,2);
        ...
        board.moveFigure(new Point(CordinateX.A, 2), new Point(CordinateX.C, 4));
        board.printBoard();
        System.out.println(board.isAvailablePoint(new Point(CordinateX.H, 9)));
